              ...
              <motion.div variants={fadeInUp}>
                <SectionCard variant="grimoire" className="h-full bg-black-override">
                  <div className="text-center h-full flex flex-col">
                    ...
                    <div className="text-4xl font-bold mb-6 text-emerald-medium">₹2,999<span className="text-lg text-gray-400">/mo</span></div>
              ...
              <motion.div variants={fadeInUp}>
                <SectionCard variant="grimoire" className="h-full border-gold-soft/50 relative bg-black-override">
                  ...
                  <div className="text-center h-full flex flex-col">
                    ...
                    <div className="text-4xl font-bold mb-6 text-emerald-medium">₹5,999<span className="text-lg text-gray-400">/mo</span></div>
                    <ul className="text-left space-y-3 mb-8 flex-grow">
              ...
              <motion.div variants={fadeInUp}>
                <SectionCard variant="grimoire" className="h-full bg-black-override">
                  <div className="text-center h-full flex flex-col">
                    ...
                    <div className="text-4xl font-bold mb-6 text-emerald-medium">₹8,999<span className="text-lg text-gray-400">/mo</span></div>
                    <ul className="text-left space-y-3 mb-8 flex-grow">
